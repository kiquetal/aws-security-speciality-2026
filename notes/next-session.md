...
### Pre-Written Questions: REMOVED (2026-06-24)

> Stale questions deleted. 5/10 tested mastered patterns = waste of time.
> All future questions MUST be generated LIVE at drill time, filtered against
> `maintenance-plan.md` mastered-patterns exclusion list.
> `next-session.md` is now TOPIC GUIDANCE ONLY, never a question source.
