...
| 🔴 8 | cfn-guard bypassable vs Config proactive service-level | Q1387, Q1220, Q1271 | D6 | 3 |
| 🔴 9 | Network Firewall TLS inspection | Q35, Q87, Q152 | D3 | 3 |
| 🔴 10 | GuardDuty finding types (Impact vs CryptoCurrency) | Q178, Q226, Q489 | D1 | 3 |
| 🔴 11 | KMS key policy root = delegation, not grant | Q264, Q503, Q687 | D4, D5 | 3 |
| 🔴 12 | Default encryption vs bucket policy Deny | Q426, Q626, Q643 | D5 | 3 |
| 🔴 13 | kms:ViaService + SCP | Q488, Q495, Q495 | D4, D5 | 3 |
| 🔴 14 | Detect C2 = GuardDuty (zero code) | Q571, Q584, Q633 | D1 | 3 |
| 🔴 15 | S3 server access logging = ACLs | Q864, Q868, Q903 | D5, D6 | 3 |
| 🔴 16 | Security services comparison | Q5, Q24 | D1 | 2 |
| 🔴 17 | RAM vs KMS Grants | Q11, Q37 | D4 | 2 |
| 🔴 18 | Cross-account KMS + SCP evaluation | Q70, Q256 | D4, D5 | 2 |
| 🔴 19 | Session policy bypass by resource-based policy | Q96, Q169 | D4 | 2 |
| 🔴 20 | Detect vs prevent (GuardDuty vs Access Analyzer) | Q187, Q233 | D1 | 2 |
| 🔴 21 | SCP for preventive enforcement | Q261, Q413 | D3, D4 | 2 |
| 🔴 22 | Service Catalog (self-service) | Q274, Q277 | D6 | 2 |
| 🔴 23 | StackSets no auto-remediation | Q283, Q439 | D6 | 2 |
| 🔴 24 | Firewall Manager auto-remediation | Q284, Q435 | D6 | 2 |
| 🔴 25 | Access Analyzer unused + policy generation | Q374, Q1003 | D1, D4 | 2 |
| 🔴 26 | Data perimeter (RCP blocks IN, SCP blocks OUT) | Q398, Q1095 | D4, D6 | 2 |
| 🔴 27 | Native org-wide deployment | Q483, Q492 | D6 | 2 |
| 🔴 28 | Access Analyzer + GuardDuty both fire | Q518, Q652 | D1, D4 | 2 |
| 🔴 29 | GuardDuty ≠ failed attempts | Q534, Q594 | D1, D4, D5, D6 | 2 |
| 🔴 30 | Gateway endpoint policy as additional gate | Q535, Q1080 | D3, D4, D5 | 2 |
| 🔴 31 | Session policy + server-side KMS | Q591, Q679 | D4, D5, D6 | 2 |
| 🔴 32 | RCP scope (your resources only, not outbound) | Q683, Q698 | D4, D6 | 2 |
| 🔴 33 | Access Analyzer static + GuardDuty ≠ failed attempts | Q706, Q1260 | D1, D4 | 2 |
| 🔴 34 | Glacier Vault Lock vs Object Lock | Q800, Q822 | D5 | 2 |
| 🔴 35 | Sign=private, verify=public | Q812, Q824 | D5 | 2 |
| 🔴 36 | S3 Access Grants prefix overlap | Q819, Q826 | D1, D5 | 2 |
| 🔴 37 | Credential leak IR (Deny-all before investigate) | Q862, Q867 | D2 | 2 |
| 🔴 38 | Kinesis consumer = Decrypt + DescribeKey | Q879, Q1100 | D3, D5 | 2 |
| 🔴 39 | Kinesis + KMS VPC endpoints (timeout = network) | Q918, Q950 | D3, D5 | 2 |
| 🔴 40 | API Gateway mTLS = custom domain + S3 truststore | Q967, Q1012 | D3 | 2 |
| 🔴 41 | EMR in-transit = security config + PEM certs | Q1030, Q1073 | D5 | 2 |
| 🔴 42 | IoT revocation = registry. API GW mTLS revocation = CRL in truststore | Q1032, Q1070 | D3, D5 | 2 |
| 🔴 43 | State Manager OnBoot + schedule (dual triggers) | Q1048, Q1071 | D1, D3 | 2 |
| 🔴 44 | Inspector SBOM = native export + bucket policy | Q1059, Q1119 | D3 | 2 |
| 🔴 45 | Public-facing = 0.0.0.0/0 on 443 | Q1239, Q1250 | D3 | 2 |
| 🔴 46 | Rotation Lambda can't reach DB = SG issue | Q1242, Q1254 | D3, D5 | 2 |
| 🔴 47 | Security Hub setup ordering (E-D-M-A) | Q1244, Q1273 | D6 | 2 |
| 🔴 48 | Detective needs finding. No finding = CW Logs Insights | Q1277, Q1314 | D1 | 2 |
| 🟡 49 | CloudTrail data vs management events | Q1 | D1 | 1 |
| 🟡 50 | Basic vs Advanced event selectors | Q2 | D1 | 1 |
| 🟡 51 | Troubleshooting (Task 1.3) | Q6 | D1 | 1 |
| 🟡 52 | Policy layers reference | Q7 | D4 | 1 |
| 🟡 53 | faq-ram-vs-rcp.md | Q12 | D4 | 1 |
| 🟡 54 | GuardDuty vs CloudTrail | Q13 | D1 | 1 |
| 🟡 55 | DNS Firewall | Q14 | D3 | 1 |
| 🟡 56 | Cross-account patterns | Q15 | D5 | 1 |
| 🟡 57 | CloudTrail Lake vs S3+Athena | Q23 | D1 | 1 |
| 🟡 58 | Console direct bypasses Config proactive | Q1389 | D6 | 1 |
| 🟡 59 | NACLs stateless | Q34 | D3 | 1 |
| 🟡 60 | RAM vs RCP | Q38 | D4 | 1 |
| 🟡 61 | RCP exemptions (SLR vs service principal) | Q39 | D4 | 1 |
| 🟡 62 | RCP exemptions (PrincipalIsAWSService) | Q42 | D4 | 1 |
| 🟡 63 | Cross-account KMS | Q53 | D4 | 1 |
| 🟡 64 | STS session revocation | Q62 | D4 | 1 |
| 🟡 65 | Session tags + ABAC | Q63 | D4 | 1 |
| 🟡 66 | SCP + RequestTag enforcement | Q68 | D4 | 1 |
| 🟡 67 | Session tags + ABAC (ResourceTag vs RequestTag) | Q72 | D4 | 1 |
| 🟡 68 | Session policy as ceiling | Q78 | D4 | 1 |
| 🟡 69 | SCP cannot be bypassed | Q83 | D4 | 1 |
| 🟡 70 | MRK independent key policies | Q84 | D5 | 1 |
| 🟡 71 | Object Lock Compliance vs Legal Hold | Q85 | D5 | 1 |
| 🟡 72 | Detect C2 = GuardDuty (not DNS Firewall) | Q106 | D1 | 1 |
| 🟡 73 | Imported key rotation procedure | Q114 | D5 | 1 |
| 🟡 74 | SCP for preventive guardrails | Q119 | D6 | 1 |
| 🟡 75 | RAM for resource sharing | Q126 | D6 | 1 |
| 🟡 76 | DNS Firewall rule actions | Q129 | D3 | 1 |
| 🟡 77 | GuardDuty vs Inspector | Q132 | D1 | 1 |
| 🟡 78 | DNS Firewall rule structure | Q134 | D3 | 1 |
| 🟡 79 | Step Functions for IR | Q138 | D2 | 1 |
| 🟡 80 | Access Analyzer modes | Q144 | D1 | 1 |
| 🟡 81 | Validate findings (Task 2.2.3) | Q148 | D2 | 1 |
| 🟡 82 | Data masking (Macie ≠ logs) | Q181 | D5 | 1 |
| 🟡 83 | RCP exemptions (SLR) | Q183 | D4 | 1 |
| 🟡 84 | Access Analyzer policy validation vs Simulator | Q184 | D4 | 1 |
| 🟡 85 | KMS auto-rotation retention | Q192 | D5 | 1 |
| 🟡 86 | KMS key policy delegation + GenerateDataKey | Q206 | D5 | 1 |
| 🟡 87 | Firewall Manager SG audit | Q208 | D3 | 1 |
| 🟡 88 | GuardDuty is regional + agentless | Q232 | D1 | 1 |
| 🟡 89 | CloudWatch Logs Insights vs Detective | Q236 | D1 | 1 |
| 🟡 90 | SCP for preventive guardrails (Control Tower) | Q251 | D6 | 1 |
| 🟡 91 | Secrets Manager cross-region replication | Q258 | D5 | 1 |
| 🟡 92 | SCIM provisioning (Identity Center) | Q263 | D4 | 1 |
| 🟡 93 | Audit Manager vs Artifact | Q271 | D6 | 1 |
| 🟡 94 | StackSets vs Firewall Manager | Q273 | D6 | 1 |
| 🟡 95 | Config conformance packs | Q275 | D6 | 1 |
| 🟡 96 | StackSets vs Conformance Pack | Q276 | D6 | 1 |
| 🟡 97 | DNS Firewall ALERT ≠ finding | Q295 | D1 | 1 |
| 🟡 98 | Security Lake vs CW Logs Insights | Q303 | D1 | 1 |
| 🟡 99 | Verified Access trust providers | Q336 | D3, D4 | 1 |
| 🟡 100 | Signer revocation (job vs profile vs IAM) | Q339 | D4, D6 | 1 |
| 🟡 101 | Cognito Identity Pool + KMS permissions | Q341 | D3, D4 | 1 |
| 🟡 102 | GuardDuty suppression rules | Q372 | D1 | 1 |
| 🟡 103 | Secrets Manager rotation failure | Q376 | D5 | 1 |
| 🟡 104 | Cognito + DynamoDB ABAC (sub vs TenantId) | Q395 | D3, D4 | 1 |
| 🟡 105 | EventBridge for fast detection | Q401 | D1 | 1 |
| 🟡 106 | Timeout vs Access Denied (SG troubleshooting) | Q418 | D3 | 1 |
| 🟡 107 | KMS is regional | Q423 | D4, D5 | 1 |
| 🟡 108 | RCP same-org evaluation | Q427 | D4 | 1 |
| 🟡 109 | Secrets Manager replication ≠ MRK | Q428 | D5 | 1 |
| 🟡 110 | SCP prevents disabling services | Q440 | D6 | 1 |
| 🟡 111 | RAM + FM complementary | Q442 | D6 | 1 |
| 🟡 112 | Full governance stack | Q445 | D6 | 1 |
| 🟡 113 | StackSets limitations | Q450 | D6 | 1 |
| 🟡 114 | FM SG common policy | Q454 | D6 | 1 |
| 🟡 115 | Delegated admin (all services) | Q462 | D6 | 1 |
| 🟡 116 | Proactive guardrail (CF Hook) | Q464 | D6 | 1 |
| 🟡 117 | No single governance service | Q486 | D6 | 1 |
| 🟡 118 | SCP can't inspect payload + RCP prevents consequence | Q515 | D1, D6 | 1 |
| 🟡 119 | EventBridge for fast detection + auto-revert | Q523 | D1, D6 | 1 |
| 🟡 120 | Network FW for IP-level C2 block | Q526 | D1, D3 | 1 |
| 🟡 121 | Detection + response architecture | Q532 | D1, D3, D6 | 1 |
| 🟡 122 | GuardDuty ≠ failed attempts + Access Analyzer static analysis | Q545 | D1, D4, D5 | 1 |
| 🟡 123 | Detect vs prevent (GuardDuty vs EventBridge for behavioral) | Q640 | D1 | 1 |
| 🟡 124 | GuardDuty finding types (C2 = Trojan, not CryptoCurrency) | Q655 | D1 | 1 |
| 🟡 125 | VPC endpoints (direct KMS + DynamoDB) | Q685 | D3, D5 | 1 |
| 🟡 126 | DGA = allow-list DNS Firewall | Q690 | D1, D3 | 1 |
| 🟡 127 | NACLs stateless (Dojo Q19, Q61) | Q707 | D3 | 1 |
| 🟡 128 | Directory Service + trust direction (Dojo Q5) | Q709 | D4 | 1 |
| 🟡 129 | CloudTrail management events Read/Write (Dojo Q16) | Q710 | D1 | 1 |
| 🟡 130 | GuardDuty Trusted IP list (Dojo Q22) | Q711 | D1 | 1 |
| 🟡 131 | VPN types (Dojo Q56) | Q719 | D3 | 1 |
| 🟡 132 | CW metric filter value (Dojo Q57) | Q724 | D1 | 1 |
| 🟡 133 | ADFS vs AD Connector (Dojo Q48) | Q731 | D4 | 1 |
| 🟡 134 | AD Connector vs Simple AD | Q739 | D4 | 1 |
| 🟡 135 | EC2 EBS + kms:CreateGrant (Dojo T2 Q47) | Q745 | D5 | 1 |
| 🟡 136 | SCP ceiling implicit deny (Dojo T2 Q65) | Q747 | D4 | 1 |
| 🟡 137 | InsideAWS = SG isolation | Q761 | D2, D4 | 1 |
| 🟡 138 | S3 envelope encryption never uses kms:Encrypt | Q765 | D5 | 1 |
| 🟡 139 | Cognito Identity Pool + role (not direct STS) | Q778 | D4 | 1 |
| 🟡 140 | NACLs stateless (inbound ACCEPT + outbound REJECT) | Q781 | D3 | 1 |
| 🟡 141 | EKS Runtime Monitoring (agent required) | Q797 | D1, D3 | 1 |
| 🟡 142 | CloudFront response headers policy | Q801 | D3 | 1 |
| 🟡 143 | GuardDuty Extended Threat Detection (too new) | Q806 | D1 | 1 |
| 🟡 144 | OutsideAWS IR + IMDSv2 hardening | Q820 | D1, D2, D4 | 1 |
| 🟡 145 | GuardDuty ≠ failed attempts + AA static | Q839 | D1 | 1 |
| 🟡 146 | S3 Batch Operations cross-account + manifest region | Q855 | D4, D5 | 1 |
| 🟡 147 | S3 Batch cross-account needs bucket policy | Q857 | D4, D6 | 1 |
| 🟡 148 | SCP prevention > detect+remediate | Q858 | D4, D6 | 1 |
| 🟡 149 | S3 Batch Operations regional | Q872 | D5 | 1 |
| 🟡 150 | IoT ThingName = cert-bound, not hardware | Q880 | D3 | 1 |
| 🟡 151 | Config custom rule = Lambda (max 15min timeout) | Q881 | D1, D6 | 1 |
| 🟡 152 | CRR dest = kms:GenerateDataKey (not Encrypt) | Q883 | D5 | 1 |
| 🟡 153 | CRR rewrites encryption context to dest | Q888 | D5 | 1 |
| 🟡 154 | IoT cert revocation = instant (no CRL delay) | Q892 | D3 | 1 |
| 🟡 155 | DynamoDB + CMK = CreateGrant + DescribeKey | Q899 | D4, D5 | 1 |
| 🟡 156 | Reading comprehension (perms already present) | Q901 | D5 | 1 |
| 🟡 157 | EBS encryption by default + SCP = full prevention | Q902 | D5, D6 | 1 |
| 🟡 158 | GWLB GENEVE decapsulation | Q905 | D3 | 1 |
| 🟡 159 | Config org custom rule cross-account invoke | Q908 | D1, D6 | 1 |
| 🟡 160 | Reading comprehension (multiple missing perms) | Q911 | D3, D5 | 1 |
| 🟡 161 | CRR custom encryption context preserved | Q923 | D5 | 1 |
| 🟡 162 | CreateSampleFindings vs FIS | Q934 | D2 | 1 |
| 🟡 163 | Resilience Hub = assess, FIS = test, ARC = recover | Q935 | D2 | 1 |
| 🟡 164 | ARC zonal shift | Q936 | D2 | 1 |
| 🟡 165 | Deny * on user vs TokenIssueTime (user vs role) | Q942 | D2 | 1 |
| 🟡 166 | CloudTrail Lake (data vs mgmt + no backfill) | Q951 | D1 | 1 |
| 🟡 167 | KMS endpoint + SG (direct calls only) | Q965 | D3, D5 | 1 |
| 🟡 168 | API Gateway TOKEN vs REQUEST authorizer | Q988 | D3 | 1 |
| 🟡 169 | S3 wraps KMS errors (error surface vs root cause) | Q989 | D4, D5 | 1 |
| 🟡 170 | SageMaker notebooks vs Detective (custom vs built-in) | Q996 | D2 | 1 |
| 🟡 171 | CloudTrail Insights vs GuardDuty (complementary) | Q1004 | D1 | 1 |
| 🟡 172 | Bedrock IAM guardrail enforcement (condition key) | Q1007 | D3 | 1 |
| 🟡 173 | Q Business ACL identity mapping failure | Q1010 | D3 | 1 |
| 🟡 174 | Resource Policy = boundary rejection (before authorizer) | Q1013 | D3 | 1 |
| 🟡 175 | Private API timeout = Resource Policy rejection (not always network) | Q1025 | D3, D5 | 1 |
| 🟡 176 | Access Grants + SSE-KMS needs explicit kms:Decrypt on role | Q1026 | D4, D5 | 1 |
| 🟡 177 | Well-Architected Tool = architecture review + improvement plan | Q1031 | D6 | 1 |
| 🟡 178 | IoT Core = registry-based revocation (instant) | Q1035 | D3 | 1 |
| 🟡 179 | Key policy conditions enforced regardless of caller's identity policy | Q1040 | D4, D5 | 1 |
| 🟡 180 | Inspector SBOM = on-demand API (EventBridge + Lambda to schedule) | Q1051 | D3 | 1 |
| 🟡 181 | Hardcoded credential → always Secrets Manager | Q1054 | D3 | 1 |
| 🟡 182 | mTLS 403 = cert expired (if same CA works for others) | Q1055 | D3 | 1 |
| 🟡 183 | RCP evaluates S3 CALLER (Lambda), not original HTTP client | Q1074 | D4, D6 | 1 |
| 🟡 184 | CRR preserves source custom encryption context | Q1075 | D5 | 1 |
| 🟡 185 | Lambda = no EBS/AMI forensics (ephemeral) | Q1079 | D2, D3 | 1 |
| 🟡 186 | OutsideAWS + can't disrupt = TokenIssueTime + snapshot | Q1108 | D2 | 1 |
| 🟡 187 | Cron vs Rate vs PITR | Q1124 | D5 | 1 |
| 🟡 188 | Traffic Mirroring = passive. GWLB = inline. 3x failed. | Q1126 | D3 | 1 |
| 🟡 189 | State Manager = schedule enforcement (proactive) | Q1127 | D1, D3 | 1 |
| 🟡 190 | Session Manager logging = session activity (not CW Agent) | Q1132 | D2 | 1 |
| 🟡 191 | DNSSEC broken chain = DS in parent | Q1135 | D3 | 1 |
| 🟡 192 | Stack Policy = protect resources inside stack | Q1138 | D6 | 1 |
| 🟡 193 | Federated user ARN = sts:: not iam:: | Q1139 | D4 | 1 |
| 🟡 194 | SCP = what key, Key policy = who uses it | Q1140 | D4, D5 | 1 |
| 🟡 195 | mTLS = custom domain + S3 | Q1172 | D3 | 1 |
| 🟡 196 | Bedrock guardrail condition key | Q1187 | D3 | 1 |
| 🟡 197 | Config also detects StopLogging | Q1201 | D1 | 1 |
| 🟡 198 | mTLS S3 versioning required | Q1207 | D3 | 1 |
| 🟡 199 | Well-Architected Tool milestones | Q1211 | D6 | 1 |
| 🟡 200 | cfn-guard vs Config proactive (template validation) | Q1213 | D6 | 1 |
| 🟡 201 | WAT milestones = no automation | Q1221 | D6 | 1 |
| 🟡 202 | Stack Policy default deny + selective Deny | Q1225 | D6 | 1 |
| 🟡 203 | WAT milestones = no automated evidence | Q1226 | D6 | 1 |
| 🟡 204 | User = Deny *. Role = TokenIssueTime. | Q1231 | D2 | 1 |
| 🟡 205 | WAT = self-reported, no automation | Q1233 | D6 | 1 |
| 🟡 206 | IAM Credential Report 4-hour cache | Q1234 | D1 | 1 |
| 🟡 207 | Permission boundary delegation vs Service Catalog | Q1235 | D4 | 1 |
| 🟡 208 | SCP attachment OU vs accounts | Q1236 | D4, D6 | 1 |
| 🟡 209 | EBS snapshot sharing (copy with CMK, no volume needed) | Q1237 | D5 | 1 |
| 🟡 210 | SCP block root (containment vs hygiene) | Q1238 | D4, D6 | 1 |
| 🟡 211 | CW agent ships logs (not SSM agent) | Q1240 | D1 | 1 |
| 🟡 212 | Boot-time retrieval vs deploy-time injection | Q1241 | D5 | 1 |
| 🟡 213 | VPC Flow vs TGW Flow Logs scope | Q1243 | D1, D3 | 1 |
| 🟡 214 | Resolver vs DNS query logging direction | Q1276 | D1 | 1 |
| 🟡 215 | Remediation succeeds but returns = re-creation | Q1287 | D1 | 1 |
| 🟡 216 | Macie enabled ≠ Macie scanning | Q1293 | D1 | 1 |
| 🟡 217 | Preserve evidence = EBS snapshot | Q1295 | D2, D3 | 1 |
| 🟡 218 | NAA finds, RA explains | Q1296 | D3 | 1 |
| 🟡 219 | Trojan = outbound. Recon = inbound. | Q1302 | D1 | 1 |
| 🟡 220 | EventBridge=seconds, Config=minutes | Q1309 | D1 | 1 |
| 🟡 221 | SCP + conformance pack = OU-level auto-apply | Q1313 | D6 | 1 |
| 🟡 222 | cfn-guard bypassable vs Config proactive | Q1354 | D6 | 1 |
| 🟡 223 | EBS encryption by default + SCP | Q1371 | D5 | 1 |
