...
| **❌ Wrong** | 18 (17%) |
| **Sessions** | 18 |
| **Re-tests Passed** | 23 of 29 |

## Domain Breakdown

| Domain | ✅ | ⚠️ | ❌ | Total | Score % | Weak? |
|---|---|---|---|---|---|---|
| D1: Detection | 6 | 3 | 4 | 13 | 46% | 🔴 |
...
| 🟡 27 | Session policy bypass by resource-based policy | Q96 | D4 | 1 |
| 🟡 28 | Detect vs prevent (GuardDuty vs policy) | Q100 | D5 | 1 |
