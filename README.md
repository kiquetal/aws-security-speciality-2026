...
[![Questions Attempted](https://img.shields.io/badge/Questions-1,695-blue)](#current-progress) [![Accuracy](https://img.shields.io/badge/Accuracy-79%25-green)](#current-progress) [![Study Hours](https://img.shields.io/badge/Study_Hours-112_hrs-orange)](#current-progress) [![Sessions](https://img.shields.io/badge/Sessions-120-purple)](#current-progress)
...
| **Questions Attempted** | 1,695 |
| **Accuracy** | 79% overall, 85-90% on recent sessions |
| **Sessions** | 120 |
| **Study Hours** | 112+ hours |
